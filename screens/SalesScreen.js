    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            if (currentUser) {
                ...
                const response = await fetch(`http://192.168.170.172:8000/Sales/products/${firebaseId}/`);
        ...
        const fetchUser = async () => {
            try {
                ...
                if (currentUser) {
                    ...
                    const response = await fetch(`http://192.168.170.172:8000/Auth/get_user_role/${firebaseId}/`);
                    const data = await response.json();
                    setUser(data);
                    console.log(data);
                }

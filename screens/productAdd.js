...
const ProductsScreen = () => {
    ...
    const fetchProducts = async (firebaseUserId) => {
        try {
            const response = await fetch(`http://192.168.81.95:8000/Sales/products/${firebaseUserId}/`);
    ...
    const fetchBranches = async (firebaseUserId) => {
        try {
            const response = await fetch(`http://192.168.81.95:8000/Sales/branches/${firebaseUserId}/`);
            const data = await response.json();
    ...
    const handleCreateProduct = async () => {
        ...
        try {
            ...
            const url = product.id
                ? `http://192.168.81.95:8000/Sales/products/${product.id}/`
                : `http://192.168.81.95:8000/Sales/Add_products/${firebaseId}/`;
                    ...
                    { text: 'Cancel', style: 'cancel' },
                    {
                        ...
                        onPress: async () => {
                            const response = await fetch(
                                `http://192.168.81.95:8000/Sales/products/${productId}/delete/`,
                                { method: 'DELETE' }
                            );
    ...
    const handleTransferStock = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `http://192.168.81.95:8000/Sales/transfer_stock/${transferProduct.id}/`,
                {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',

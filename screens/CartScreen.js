...
const OrderScreen = () => {
    ...
    const fetchCustomers = async () => {
        ...
        try {
            const response = await fetch("http://192.168.51.77:8000/Sales/fetch_customer/");
    ...
    const fetchExchangeRate = async (currencyName) => {
        try {
            const response = await fetch(`http://192.168.51.77:8000/Sales/exchange_rate/${currencyName}`);
            const data = await response.json();
    ...
    const handleSubmitTransaction = async () => {
        ...
        try {
            const response = await fetch('http://192.168.51.77:8000/Sales/create_transaction/', {
                method: 'POST',
                headers: {
